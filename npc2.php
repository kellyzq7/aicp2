...
if (isset($_SESSION["email"])) {//check if user is logged in
  try {
    ...
    $sth = $dbh->prepare("UPDATE user SET `position`=16 WHERE email=:login_email");
...
<html lang="en-US">
  ...
  <body>
    <h1>Welcome to NPC 2</h1>
    <p>a hard decision awaits you <a href = "finaldecision1.php">here</a></p>
